...
{
    return to_string(ownerID) + "," + bikeID + "," + city + "," + brand + "," + model + "," + color + "," + engine_size + "," + description + "," + to_string(credit) + "," + to_string(round(requiredScore)) + "," + to_string(round(motorbike_rating_score)) + "," + to_string(isRented);
}
